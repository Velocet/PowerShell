...
function Get-MotD {
  ...
  Process {
    ...
    $IPext = [string]$(Invoke-RestMethod http://ipinfo.io/json -TimeoutSec 1 | Select-Object -ExpandProperty ip)
    ...
    Write-Host -Object ("$Current_Load @ $CPU_Temp") -NoNewline -ForegroundColor Cyan
